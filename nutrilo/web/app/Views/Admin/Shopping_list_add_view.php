        ...
        <div class="content">
            <div class="container-fluid">
                <div class="container-member">
                    ...
                    <?php if ($title == 'Edit') { ?>
                        <form action="<?php echo site_url('/admin/shopping/updateshoppinglist'); ?>" method="post">
                    <?php } else { ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan nama yang akan belanja" value="<?= $data->name ?>" required>
                                </div>
                                <div class="col-xs-6">
                                    <label>Nomor Hp<span class="text-danger">*</span></label>
                                    <input type="number" name="phone" id="phone" class="form-control" placeholder="Masukkan nomor hp yang belanja" value="<?= $data->phone ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Belanja<span class="text-danger">*</span></label>
                            <input placeholder="Masukkan tanggal belanja" type="text" class="form-control" id="datepicker" name="shopping_date" value="<?= $data->shopping_date ?>">
                        </div>
                        <div class="form-group">
                            <label>Tempat Belanja<span class="text-danger">*</span></label>
                            <input placeholder="Masukkan tempat belanja" type="text" class="form-control" id="shopping_place" name="shopping_place" value="<?= $data->shopping_place ?>">
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <select class="form-control" name="payment_type" id="payment_type">
                                        <?php foreach ($payments as $payment) : ?>
                                            <?php if ($data->payment_type_id == $payment->id) { ?>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input placeholder="Masukkan sumber dana belanja" type="text" class="form-control" id="money_source" name="money_source" value="<?= $data->money_source ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Catatan (Jika ada)</label>
                            <textarea cols="20" rows="3" name="other_info" id="other_info" class="form-control" placeholder="Masukkan keterangan lainnya (jika ada)" value="<?= $data->other_info ?>"><?= $data->other_info ?></textarea>
                        </div>
                        <div class="form-group">
                                ...
                                <table class="table" id="table-shopping">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $i++; ?>
                                            <tr id="row1">
                                            <td>
                                                <select class="form-control ingredients1"  name="ingredients[]" id="ingredients" onchange="changeValue()">
                                            ...
                                            <td id="qty"><input type="number" class="qty1" name="quantity[]" id="quantity" class="form-control" placeholder="Masukkan jumlah" value="1" onkeyup="setQty()" required></td>
                                            <td id="unit_price"><input type="number" class="up1" name="unit_price[]" id="unit_price" class="form-control" placeholder="Masukkan harga satuan" value="<?= $ingredients[0]['purchase_price'] ?>" onkeyup="setTotal()" required></td>
                                            <td id="total_price"><input type="number" class="tp1" name="total_price[]" id="total_price" class="form-control" placeholder="Masukkan total harga" value="<?= $ingredients[0]['purchase_price'] ?>" onkeyup="setUnitPrice()" required></td>
                                        </tr>
                                        <?php } else { ?>
                                        ...
                                        <tr id="row<?= $i ?>">
                                            ...
                                            <td id="qty"><input type="number" class="qty<?= $i ?>" name="quantity[]" id="quantity" class="form-control" placeholder="Masukkan jumlah" value="<?= $item->quantity ?>" onkeyup="setQty()" step="any" required></td>
                                            <td id="unit_price"><input type="number" class="up<?= $i ?>" name="unit_price[]" id="unit_price" class="form-control" placeholder="Masukkan harga satuan" value="<?= $item->unit_price ?>" onkeyup="setTotal()" required></td>
                                            <td id="total_price"><input type="number" class="tp<?= $i ?>" name="total_price[]" id="total_price" class="form-control" placeholder="Masukkan total harga" value="<?= $item->total_price ?>" onkeyup="setUnitPrice()" required></td>
                                            <?php if ($i != 1) { ?>
    ...
    function setQty(e) {
        ...
        if (targetVal[targetVal.length-1] != '.'){
            if (targetVal.indexOf('.') > -1) {
                var ingVal = $(".ingredients"+id+" option:selected").text();
                if (ingVal.includes("gram")){
